...
const RAIC_INDICATOR_STYLES: { [key in RAICType & string]: { colors: string, letter: string, title: string } } = {
...
const QuestionBrick: React.FC<QuestionBrickProps> = ({ projectId, questionId, questionText }) => {
    ...
    const handleRaicClick = (e: React.MouseEvent) => {
        e.stopPropagation();
    ...
    return (
        ...
        >
            ...
            >
                <p className="line-clamp-3 pr-2">{questionText}</p>
